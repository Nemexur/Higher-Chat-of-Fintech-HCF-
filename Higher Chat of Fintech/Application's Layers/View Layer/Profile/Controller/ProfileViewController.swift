...
//        buttonsAvailability(operationButton, availability: true)
    ...
    private func setupGestures() {
        ...
        let tapToAnimateTinkoffEmblem: UILongPressGestureRecognizer = UILongPressGestureRecognizer(target: self, action: #selector(ProfileViewController.startAnimationOnTap(_:)))
